...
scp -r /home/jason/311552039_np_project3/* zhangtw528491@nplinux11.cs.nctu.edu.tw:/net/gcs/111/311552039/np_project3
...
ssh -t zhangtw528491@nplinux11.cs.nctu.edu.tw "cd np_project3; make part2; /bin/bash"
