...
scp -r /home/jason/311552039_np_project4/* zhangtw528491@nplinux11.cs.nctu.edu.tw:/net/gcs/111/311552039/np_project4
...
ssh -t zhangtw528491@nplinux1.cs.nctu.edu.tw "cd np_project4; make; /bin/bash"
